...
public class OPC implements Runnable
{
  ...
  // x,y is the center of the triangle. 
   ...
   void ledEquilateral(int fadecandy, int triangle,  int index, float x, float y, float angle){
    ...
    int i = (fadecandy - 1) * 3 + triangle - 1;
    float hue = (360/triangles.length)*i;
    triangles[i] = new Triangle(fadecandy, triangle, x, y, radians(angle-270), hue, 0);
    println("type: eqi " + "fadecandy: " + fadecandy + " tri: " + triangle + " i: " + i + " hue: " + hue);
  ...
  // x,y is the center of the triangle. 
  void isoLongFirstLeft(int fadecandy, int triangle, int index, float x, float y, float angle)
  {
    ...
    println("type: iso " + "fadecandy: " + fadecandy + " tri: " + triangle + " i: " + i + " hue: " + hue);
    
    triangles[i] = new Triangle(fadecandy, triangle, x, y, angle, hue, 1);
  ...
  // Angle is in radians, from point to base
  // x,y is the center of the triangle. 
  void isoLongFirstLeftWrong(int fadecandy, int triangle, int index, float x, float y, float angle)
  {
  ...
  // Angle is in radians, from point to base
  // x,y is the center of the triangle. 
  void isoLongFirstRight(int fadecandy, int triangle, int index, float x, float y, float angle)
  {
  ...
  // Angle is in radians, from point to base
  // x,y is the center of the triangle. 
  void isoShortFirstRight(int fadecandy, int triangle, int index, float x, float y, float angle)
  {
  ...
  // Angle is in radians, from point to base
  // x,y is the center of the triangle. 
  void isoShortFirstLeft(int fadecandy, int triangle, int index, float x, float y, float angle)
  {
